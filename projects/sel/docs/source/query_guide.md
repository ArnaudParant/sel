...
See [ES Search request body](https://www.elastic.co/guide/en/elasticsearch/reference/2.4/search-request-body.html)
...
Query string use [ES query string format](https://www.elastic.co/guide/en/elasticsearch/reference/2.4/query-dsl-query-string-query.html)
...
Query string will match the `DefaultQueryStringFieldPath` (from `conf.ini`) with [ES query string format](https://www.elastic.co/guide/en/elasticsearch/reference/2.4/query-dsl-query-string-query.html).  
...
See [Time units](https://www.elastic.co/guide/en/elasticsearch/reference/2.4/common-options.html#time-units)
